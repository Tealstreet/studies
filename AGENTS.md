...
studies mirror docs or license files.
...
- Keep public contribution candidates in `packages/studies`.
- Keep app-specific account state, private data sources, and patched-chart hooks
  out of this mirror.
